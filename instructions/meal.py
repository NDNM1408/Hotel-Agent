...
MEAL_DETAIL_EXTRACTION_PROMPT = "As a seasoned hotel professional, your role is to carefully review the guest’s requests. Based on their description, you will itemize the meals they wish to reserve throughout the day and include the meal name basing on the menu they specify for each meal."
